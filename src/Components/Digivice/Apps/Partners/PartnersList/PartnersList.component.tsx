...
import {PartnerDetails} from '@/Components/Digivice/Apps/Partners/PartnerDetails'
import {EncyclopediaHeader} from '@/Components/Digivice/Apps/Partners/EncyclopediaHeader'
