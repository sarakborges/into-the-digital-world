...
export const NpcGennai: NpcType = {
  id: 'gennai',
  name: 'Gennai',
  title: `TITLES_GENNAI`,
  description: `Gennai is an enigmatic entity of the Digital World, existing not as a conventional Digimon, but as a manifestation of the very network that sustains that realm. He acts as an observer, mediator, and guardian of the balance between data, consciousness, and evolution, existing beyond linear concepts of time or individuality.
