export const COMPOSE_DEFAULT = `Oh. Chosen child. Come closer.`
export const COMPOSE_SEE_COMPOSEABLE = `I want to compose a new Digimon.`
export const COMPOSE_INTRODUCTION = `Another old man. And who are you?`
