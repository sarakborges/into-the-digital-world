...
export const NPC_DEFAULT_TEXT = `Very important text that the NPC will talk when you get close to them.`
...
export const LOCATION_TRIGGER = `I am ready. Where can I go?`
